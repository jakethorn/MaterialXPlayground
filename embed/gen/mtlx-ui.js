...
function ShaderExportDialog({
  ...
  const frame = /*#__PURE__*/React.createElement(DialogFrame, {
    ...
    className: "mx-4 mb-2 flex items-start gap-2 rounded border border-gray-600/60 bg-gray-900/40 px-3 py-2 text-[11px] text-gray-400"
  }, /*#__PURE__*/React.createElement(MtlxIcon, {
    name: "info-circle",
    className: "w-3.5 h-3.5 mt-0.5 flex-shrink-0 text-gray-500"
  }), /*#__PURE__*/React.createElement("span", null, "ShadingLanguageX shader code is generated by the MXSLC ShadingLanguageX WASM bindings.", stages && stages.length > 1 ? ' Original is the .mxsl file you originally loaded, with no changes, while Decompiled is the current state of your MaterialX graph decompiled back into shader code.' : '', ' ', /*#__PURE__*/React.createElement("a", {
