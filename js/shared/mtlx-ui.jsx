                        ...
                        <div className="mx-4 mb-2 flex items-start gap-2 rounded border border-gray-600/60 bg-gray-900/40 px-3 py-2 text-[11px] text-gray-400">
                            ...
                            <div className="space-y-4">
                                ...
                                {stages && stages.length > 1 && (
                                    <p>"Original" is the .mxsl file you originally loaded, with no changes, while "Decompiled" is the current state of your MaterialX graph decompiled back into shader code.</p>
                                )}
                                <p>
